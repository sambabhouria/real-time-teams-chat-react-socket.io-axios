...
export default class ChatBox extends Component {
  ...
  render() {
    // console.log('ImageArray', ImageArray.initialdata);
    // console.log('ImageArray', this.props.targetUser.id);
            ...
            <NavbarComponent
              left={
                <div>
                  ...
                  {/* <Avatar
                    src={ImageArray.data[this.props.targetUser.id].image}
                    alt={"logo"}
                    size="large"
                    ...
                    type="circle flexible"
                  /> */}
                  <img src={arrayOfImage[this.props.targetUser.id]} alt=""/>
